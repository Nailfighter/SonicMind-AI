        ...
        <div className="relative z-10 w-full h-full flex flex-col items-center justify-center p-8">
          <div className="w-full max-w-md">
            ...
            <div className="mb-8">
              ...
              <div className="text-center text-lg font-semibold text-gray-700">{progress}%</div>
            </div>
            ...
            <div className="flex justify-center mt-8 space-x-2">
              ...
              <div
                className="w-3 h-3 bg-teal-500 rounded-full animate-bounce shadow-md"
                style={{ animationDelay: '0.2s' }}
              ></div>
              <div
                className="w-3 h-3 bg-orange-500 rounded-full animate-bounce shadow-md"
                style={{ animationDelay: '0.4s' }}
              ></div>
            </div>
          </div>
